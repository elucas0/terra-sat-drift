...
def example_5_simulation_pipeline():
    ...
    # Load S2 file
    loader = Sen1Floods11S2Loader(
        root_path="terra-sat-drift/datasets/sen1floods11",
        split="train",
    )
    ...
    config = SimulationConfig(
        steps=steps,
        output_dir="terra-sat-drift/tiff_folder/simulated_s2",
        processing_level="L1C",
        sh_config_path="terra-sat-drift/sh_config.json", # Optional, for metadata fetching
    )
